...
exports.removeParticipant = exports.addParticipant = exports.deleteMessage = exports.markMessagesAsRead = exports.sendMessage = exports.getMessages = exports.getChatById = exports.createChat = exports.getChats = void 0;
...
const getChats = async (req, res) => {
    try {
        ...
        const total = await Chat_1.Chat.countDocuments({
            participants: req.user._id
        });
        res.json({
            success: true,
...
const getMessages = async (req, res) => {
    try {
        ...
        const messages = await Chat_1.Message.find({ chatId })
            .sort({ createdAt: -1 })
            .limit(Number(limit) * 1)
            .skip((Number(page) - 1) * Number(limit))
            .populate('sender', 'name email avatar');
        const total = await Chat_1.Message.countDocuments({ chatId });
...
const deleteMessage = async (req, res) => {
    try {
        ...
        await Chat_1.Message.findByIdAndDelete(messageId);
        res.json({
            success: true,
